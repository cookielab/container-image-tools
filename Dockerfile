...
COPY --from=buildkit /usr/bin/buildctl /cit/bin/buildctl
COPY --from=buildkit /usr/bin/buildkitd /cit/bin/buildkitd
COPY --from=buildkit /usr/bin/buildctl-daemonless.sh /cit/bin/buildctl-daemonless
